...
### Administración
- ✅ **WireGuard VPN (integrado en router-fw)** - Acceso seguro para admins
...
ROUTER/FIREWALL
    ...
    └─ VLAN 50 (VPN) - WireGuard (en router-fw)
...
## Historial de Componentes Retirados

- `wireguard-vpn` (contenedor dedicado) fue retirado del despliegue por defecto.
- Motivo: simplificar topología, eliminar conflictos de ownership en `51820/udp`, y reducir sobrecarga de despliegue.
- Estado actual: WireGuard se ejecuta directamente dentro de `router-fw`.
